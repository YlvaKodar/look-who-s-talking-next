...
export const HowToUseText = {
    ...
    oneOne: "Name the meeting and state number of participants per present gender group. Pick a color scheme; be sure to choose a scheme where you can clearly tell the gender colors apart.",
    oneTwo: "When you´re done, click \"Start the meeting\".",
    two: "2. Use the timing tool",
    twoOne: "Everytime someone starts speaking, click the corresponding gender button. If there's a pause in the conversation, click the \"Pause\" button. When the meeting is over, click the \"End meeting button\".",
    twoTwo: "That´s all!",
    example: "Example:",
    twoExample: {
        one: "A woman starts speaking -> click the \"Woman speaking\" button.",
        two: "A man starts speaking -> click the \"Man speaking\" button.\n",
        three: "Another man starts speaking -> click the \"Man speaking\" button again.",
        four: "Nobody speaks -> click \"Pause\".",
    },
    note: "Note:",
    twoNoteOne: "You can see the clock ticking when a gender button is active. (An active gender button is slightly bigger than the other gender buttons.)  The clock will run until a gender button is pressed anew, causing it to start over, or until the meeting is paused or ended.",
    twoNoteTwo: "You DO NOT have to stop the clock manually in between two speakers.",
    twoNoteThree: "Don't worry if the displayed seconds seem to tick unevenly, it won’t affect the timing.",
    three: "3. See result in pie charts",
    threeOne: "The result will be visualized in pie charts: the meeting participants pie, the speaking time distribution pie and the statement distribution pie. (By statements, we mean speaking sessions – one gender button press equals one statement.)",
    threeTwo: "You can think of the first pie as your benchmark. If the second or third pie differs greatly from the first pie, speaking time or statements have been very unevenly distributed. ",
    threeThree: "If all pies look more or less the same, you did good in terms of gender group speaking time equality!",
    threeFour: "If you want to save the result, you can either create an account before starting a meeting, or take a screen shot of the charts. (Soon you will also have the alternative to save the statistics as a PDF.)",
    tip: "Tip:",
    ...
    lastlyOne: "Every meeting is a unique mix of circumstances and personalities. No matter what result you got, keep using the timer for a while, and note if there’s a pattern.",
    lastlyTwo: "And remember: this app is not here to judge you!",
    lastlyThree: "It is here to visualize one aspect of your conversation patterns and offer you a chance to reflect on it.",
    ...
    createAccountOne: "Use your email to sign up, and add a user name if you want to.",
    createAccountTwo: "On the dashboard overview, you will see your groups and meetings. Click on a heading or a specific group or meeting to see more.",
    groups: "Groups:",
    ...
    groupsExampleOne: "You create the group \"Office Party Committee\".",
    groupsExampleTwo: "You want other members in the committee to be able to clock meetings, since you won't always be able to attend. Therefore, you add them as \"clockers\".",
    groupsExampleThree: "A few months later, you leave the office, but the rest of the party committee still want to use the group.",
    groupsExampleFour: "You transfer the \"keeper\" status to one of the group clockers, before deleting your account.",
    meetings:  "Meetings:",
    meetingsOne: "If you create a new meeting while logged in, your meeting data will be saved, so that you can access it later. You will be listed as \"clocker\" in that meeting.",
    meetingsTwo: "If you are keeper or clocker in any meeting groups, you can choose to create the meeting within the group, or to add a past meeting to one of your groups.",
    meetingsThree: "Meetings within groups belong to all group members, and cannot be deleted by the clocker.",
    ...
    upcomingOne: "Soon you will be able to see meeting statistics from group meetings as a graph, in order to see how speaking patterns change over time.",
    upcomingTwo: "Later updates will also include a notification system for clocker requests etc.",
}